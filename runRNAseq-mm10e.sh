...
#usage: ./runRNAseq-mm10e.sh [options] [-i path/to/folder/]

#FOLDERS NEEDED IN ROOT:
  #raw/ (where raw files are)

# tophat -G /data/refs/mm10/BTmm10_ercc/genes_ercc.gtf --transcriptome-index=transcriptome_data/known_genes mm10_ercc
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
for file in "$dir"* ; do
    ...
    --no-novel-indels --transcriptome-index=/data/refs/mm10/BTmm10_ercc/transcriptome_data/known_genes /data/refs/mm10/BTmm10_ercc/mm10_ercc trimmed/$trimfile
